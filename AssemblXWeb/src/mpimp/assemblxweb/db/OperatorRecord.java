...
public class OperatorRecord {
	...
	public Boolean getIsTestOperator() {
		return isTestOperator_;
	}
	public void setIsTestOperator(Boolean isTestOperator) {
		isTestOperator_ = isTestOperator;
	}
	private Integer operatorId_;
	private String login_;
	private String password_;
	private Boolean isTestOperator_ = false;
}
