...
public class AnnotationRecord {
	...
	public AnnotationRecord(String annotationName, TuSubunitDirection direction) {
	...
	public AnnotationPartItem getAnnotationPartItem() {
		return annotationPartItem_;
	}

	public void setAnnotationPartItem(AnnotationPartItem annotationPartItem) {
		annotationPartItem_ = annotationPartItem;
	}
	...
	private AnnotationPartItem annotationPartItem_;
