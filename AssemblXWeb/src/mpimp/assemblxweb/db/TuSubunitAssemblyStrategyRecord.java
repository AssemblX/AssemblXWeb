...
public class TuSubunitAssemblyStrategyRecord {

	public TuSubunitAssemblyStrategyRecord(
			TuSubunitAssemblyStrategy assemblyStrategy,
			String assemblyStrategyName) {
		assemblyStrategy_ = assemblyStrategy;
		assemblyStrategyName_ = assemblyStrategyName;
	}
	
	public String getAssemblyStrategyName() {
		return assemblyStrategyName_;
	}
	public void setAssemblyStrategyName(String assemblyStrategyName) {
		assemblyStrategyName_ = assemblyStrategyName;
	}
	...
	private String assemblyStrategyName_;
	private TuSubunitAssemblyStrategy assemblyStrategy_;
