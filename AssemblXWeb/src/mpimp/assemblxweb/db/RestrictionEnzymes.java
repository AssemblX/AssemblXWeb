...
public class RestrictionEnzymes {
	...
	public static final String Pmel = "GTTTAAAC";
	public static final String Ascl = "GGCGCGCC";
	public static final String Swal = "ATTTAAAT";
	public static final String Sbfl = "CCTGCAGG";
	public static final String Fsel = "GGCCGGCC";
