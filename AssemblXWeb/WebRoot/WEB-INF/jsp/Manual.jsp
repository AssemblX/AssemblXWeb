...
<section id="manual">
	As compared to the AssemblX paper, the user manual provided here gives
	a more <q>hands on</q> version of the theoretical background and all
	the experimental steps that need to be performed during the assembly.
	AssemblX users with limited experience in the assembly methods that are
	part of AssemblX (SliCE, TAR or Gibson assembly) are encouraged to read
	the <a href="../../pdf/AssemblX_manual.pdf" target="_blank">manual</a>
	before beginning.
</section>
